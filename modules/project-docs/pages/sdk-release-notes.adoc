...
=== Version 3.5.4 (23 September 2024)
...
* Updated core to 1.0.2 Release notes: xref:cxx-sdk:project-docs:sdk-release-notes.adoc#version-1-0-2-23-september-2024[C++ SDK 1.0.2].
